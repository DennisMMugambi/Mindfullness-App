...
class MeditateFragment : Fragment(R.layout.fragment_meditate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setUpAll(meditationList)
        setUpQuicknEasy(meditationList)
    }

    private fun setUpAll(list: List<MeditationItem>) {

        mAdapter = GenericAdapter()
        recyclerView = binding.allRecycler
...
//        }
    ...
    private fun setUpQuicknEasy(list: List<MeditationItem>) {

        mAdapter = GenericAdapter()
        recyclerView = binding.easyItemsRecycler
        recyclerView.layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.HORIZONTAL, false)
        recyclerView.adapter = mAdapter
//        recyclerView.apply {
//            layoutManager = LinearLayoutManager(context).apply { LinearLayoutManager.HORIZONTAL }
